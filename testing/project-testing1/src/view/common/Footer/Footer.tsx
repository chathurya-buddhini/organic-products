      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold text-gray uppercase text-white">Follow us</h2>
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold text-gray uppercase text-white">Legal</h2>
              <ul className="text-white ">
                <li className="mb-4">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-white sm:text-center">© 2023 <a href="https://flowbite.com/" className="hover:underline">Flowbite™</a>. All Rights Reserved.</span>
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <a href="#" className="text-white hover:text-gray">
            ...
            <a href="#" className="text-white hover:text-gray ms-5">
